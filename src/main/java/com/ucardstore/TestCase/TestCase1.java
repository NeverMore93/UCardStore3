...
public class TestCase1 {
    public static void main(String[] args) {
        int width=250; 											//设置二维码的宽
        int height=250;											//设置二维码的长
        String format="png";									//设置二维码图片的格式
        String contents="https://itunes.apple.com/us/app/ucardstore-send-share-real/id966372400";			//设置的连接地址
        ...
        try{
            ...
            File files=new File("img2.png");						//文件
